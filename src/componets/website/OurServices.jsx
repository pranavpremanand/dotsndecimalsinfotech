    ...
    <div className="py-[5rem] bg-[#101010] text-white">
      ...
      >
        ...
        <p data-aos="fade-up" className="desc max-w-[50rem]">
          At Dots&Decimals Infotech, we’re driven by a passion for helping
          businesses harness the power of technology to innovate, streamline
          operations, and achieve their goals. Our broad range of services is
          designed to cater to the unique needs of businesses across industries.
          Whether you're looking to build an intuitive website, create a
          cutting-edge mobile app, or dive into the world of AI and blockchain,
          we provide tailored solutions that make a real impact. Here’s a closer
